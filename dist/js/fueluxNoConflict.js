/*!
 * Fuel UX EDGE - Built 2015/04/10, 1:56:52 PM
...
( function( factory ) {
	...
	( function( $ ) {
		...
		var old = $.fn.checkboxF3;

		// CHECKBOX CONSTRUCTOR AND PROTOTYPE

		var Checkbox = function( element, options ) {
			this.options = $.extend( {}, $.fn.checkboxF3.defaults, options );
		...
		$.fn.checkboxF3.defaults = {};

		$.fn.checkboxF3.Constructor = Checkbox;

		$.fn.checkboxF3.noConflict = function() {
			$.fn.checkboxF3 = old;
			return this;
		};
		...
		$( document ).on( 'mouseover.fu.checkbox.data-api', '[data-initialize=checkbox]', function( e ) {
			...
			if ( !$control.data( 'fu.checkbox' ) ) {
				$control.checkboxF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Combobox = function( element, options ) {
			...
			this.options = $.extend( {}, $.fn.comboboxF3.defaults, options );
		...
		$.fn.comboboxF3.defaults = {
			autoResizeMenu: true
		};

		$.fn.comboboxF3.Constructor = Combobox;

		$.fn.comboboxF3.noConflict = function() {
			$.fn.comboboxF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.combobox.data-api', '[data-initialize=combobox]', function( e ) {
			...
			if ( !$control.data( 'fu.combobox' ) ) {
				$control.comboboxF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Datepicker = function( element, options ) {
			this.$element = $( element );
			this.options = $.extend( true, {}, $.fn.datepickerF3.defaults, options );
		...
		$.fn.datepickerF3 = function( option ) {
			var args = Array.prototype.slice.call( arguments, 1 );
			var methodReturn;
		...
		$.fn.datepickerF3.Constructor = Datepicker;

		$.fn.datepickerF3.noConflict = function() {
			$.fn.datepickerF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.datepicker.data-api', '[data-initialize=datepicker]', function( e ) {
			...
			if ( !$control.data( 'datepicker' ) ) {
				$control.datepickerF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		$.fn.dropdownautoflipF3 = function() {
			/* empty */
		};
	...
	( function( $ ) {
		...
		var Loader = function( element, options ) {
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.loaderF3.defaults, options );
		...
		$.fn.loaderF3.defaults = {};

		$.fn.loaderF3.Constructor = Loader;

		$.fn.loaderF3.noConflict = function() {
			$.fn.loaderF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var Placard = function( element, options ) {
			var self = this;
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.placardF3.defaults, options );
		...
		Placard.prototype = {
			...
			show: function() {
				...
				if ( other.length > 0 ) {
					...
					other.placardF3( 'externalClickListener', {}, true );
				}
		...
		$.fn.placardF3.Constructor = Placard;

		$.fn.placardF3.noConflict = function() {
			$.fn.placardF3 = old;
			return this;
		};
		...
		$( document ).on( 'focus.fu.placard.data-api', '[data-initialize=placard]', function( e ) {
			...
			if ( !$control.data( 'fu.placard' ) ) {
				$control.placardF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Radio = function( element, options ) {
			this.options = $.extend( {}, $.fn.radioF3.defaults, options );
		...
		$.fn.radioF3.Constructor = Radio;

		$.fn.radioF3.noConflict = function() {
			$.fn.radioF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var Search = function( element, options ) {
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.searchF3.defaults, options );
		...
		$.fn.searchF3.defaults = {
			clearOnEmpty: false
		};

		$.fn.searchF3.Constructor = Search;

		$.fn.searchF3.noConflict = function() {
			$.fn.searchF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var old = $.fn.selectlistF3;
		// SELECT CONSTRUCTOR AND PROTOTYPE

		var Selectlist = function( element, options ) {
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.selectlistF3.defaults, options );
		...
		$.fn.selectlistF3 = function( option ) {
			var args = Array.prototype.slice.call( arguments, 1 );
			var methodReturn;
		...
		$.fn.selectlistF3.defaults = {};

		$.fn.selectlistF3.Constructor = Selectlist;

		$.fn.selectlistF3.noConflict = function() {
			$.fn.selectlistF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.selectlist.data-api', '[data-initialize=selectlist]', function( e ) {
			...
			if ( !$control.data( 'fu.selectlist' ) ) {
				$control.selectlistF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Spinbox = function( element, options ) {
			...
			this.options = $.extend( {}, $.fn.spinboxF3.defaults, options );
		...
		$.fn.spinboxF3.Constructor = Spinbox;

		$.fn.spinboxF3.noConflict = function() {
			$.fn.spinboxF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.spinbox.data-api', '[data-initialize=spinbox]', function( e ) {
			...
			if ( !$control.data( 'fu.spinbox' ) ) {
				$control.spinboxF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Tree = function Tree( element, options ) {
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.treeF3.defaults, options );
		...
		$.fn.treeF3 = function tree( option ) {
			var args = Array.prototype.slice.call( arguments, 1 );
			var methodReturn;
		...
		$.fn.treeF3.Constructor = Tree;

		$.fn.treeF3.noConflict = function() {
			$.fn.treeF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var Wizard = function( element, options ) {
			...
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.wizardF3.defaults, options );
		...
		$.fn.wizardF3.Constructor = Wizard;

		$.fn.wizardF3.noConflict = function() {
			$.fn.wizardF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var InfiniteScroll = function( element, options ) {
			...
			this.options = $.extend( {}, $.fn.infinitescrollF3.defaults, options );
		...
		$.fn.infinitescrollF3 = function( option ) {
			var args = Array.prototype.slice.call( arguments, 1 );
			var methodReturn;
		...
		$.fn.infinitescrollF3.defaults = {
			dataSource: null,
			hybrid: false, //can be true or an object with structure: { 'label': (markup or jQuery obj) }
			percentage: 95 //percentage scrolled to the bottom before more is loaded
		};

		$.fn.infinitescrollF3.Constructor = InfiniteScroll;

		$.fn.infinitescrollF3.noConflict = function() {
			$.fn.infinitescrollF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		var Pillbox = function( element, options ) {
			...
			this.options = $.extend( {}, $.fn.pillboxF3.defaults, options );
		...
		*/
		...
		$.fn.pillboxF3.Constructor = Pillbox;

		$.fn.pillboxF3.noConflict = function() {
			$.fn.pillboxF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.pillbox.data-api', '[data-initialize=pillbox]', function( e ) {
			...
			if ( !$control.data( 'fu.pillbox' ) ) {
				$control.pillboxF3( $control.data() );
			}
		} );
	...
	( function( $ ) {
		...
		var Repeater = function( element, options ) {
			...
			this.options = $.extend( {}, $.fn.repeaterF3.defaults, options );
			...
			this.$filters.selectlistF3();
			this.$pageSize.selectlistF3();
			this.$primaryPaging.find( '.combobox' ).comboboxF3();
			this.$search.searchF3();
			...
			this.$loader.loaderF3();
			this.$loader.loaderF3( 'pause' );
		...
		Repeater.prototype = {
			...
			clear: function( options ) {
				...
				viewTypeObj = $.fn.repeater.viewTypes[ thisF3.viewType ] || {};
			...
			destroy: function() {
				...
				this.$element.find( '.combobox' ).comboboxF3( 'destroy' );
				this.$element.find( '.selectlist' ).selectlistF3( 'destroy' );
				this.$element.find( '.search' ).searchF3( 'destroy' );
				if ( this.infiniteScrollingEnabled ) {
					$( this.infiniteScrollingCont ).infinitescrollF3( 'destroy' );
				}
			...
			getDataOptions: function( options ) {
				...
				opts.filter = ( this.$filters.length > 0 ) ? this.$filters.selectlistF3( 'selectedItem' ) : {
					text: 'All',
					value: 'all'
				};
				...
				if ( !this.infiniteScrollingEnabled ) {
					opts.pageSize = ( this.$pageSize.length > 0 ) ? parseInt( this.$pageSize.selectlistF3( 'selectedItem' ).value, 10 ) : 25;
				}
				...
				viewDataOpts = $.fn.repeater.viewTypes[ thisF3.viewType ] || {};
			...
			infiniteScrollPaging: function( data, options ) {
				...
				if ( ( this.currentPage + 1 ) >= pages ) {
					this.infiniteScrollingCont.infinitescrollF3( 'end', end );
				}
			},
			...
			initViewTypes: function( callback ) {
				...
				for ( i in $.fn.repeaterF3.viewTypes ) {
					viewTypes.push( $.fn.repeaterF3.viewTypes[ i ] );
				}
			...
			render: function( options ) {
				...
				var viewTypeObj = $.fn.repeater.viewTypes[ thisF3.viewType ] || {};
				...
				if ( !this.infiniteScrollingEnabled || ( this.infiniteScrollingEnabled && viewChanged ) ) {
					this.$loader.show().loaderF3( 'play' );
				}
				...
				this.viewOptions.dataSource( dataOptions, function( data ) {
					...
					self.runRenderer( viewTypeObj, data, function() {
						...
						self.$loader.hide().loaderF3( 'pause' );
		...
		$.fn.repeaterF3.viewTypes = {};

		$.fn.repeaterF3.Constructor = Repeater;

		$.fn.repeaterF3.noConflict = function() {
			$.fn.repeaterF3 = old;
			return this;
		};
	...
	( function( $ ) {
		...
		if ( $.fn.repeater ) {
			//ADDITIONAL METHODS
			$.fn.repeater.Constructor.prototypeF3.list_clearSelectedItems = function() {
				this.$canvas.find( '.repeater-list-check' ).remove();
				this.$canvas.find( '.repeater-list table tbody tr.selected' ).removeClass( 'selected' );
			};

			$.fn.repeater.Constructor.prototypeF3.list_highlightColumn = function( index, force ) {
			...
			$.fn.repeater.Constructor.prototypeF3.list_getSelectedItems = function() {
				var selected = [];
			...
			$.fn.repeater.Constructor.prototypeF3.list_positionHeadings = function() {
			...
			$.fn.repeater.Constructor.prototypeF3.list_setSelectedItems = function( items, force ) {
			...
			$.fn.repeater.Constructor.prototypeF3.list_sizeHeadings = function() {
			...
			$.fn.repeater.defaults = $.extend( {}, $.fn.repeaterF3.defaults, {
	...
	( function( $ ) {
		...
		if ( $.fn.repeater ) {
			//ADDITIONAL METHODS
			$.fn.repeater.Constructor.prototypeF3.thumbnail_clearSelectedItems = function() {
				this.$canvas.find( '.repeater-thumbnail-cont .selectable.selected' ).removeClass( 'selected' );
			};

			$.fn.repeater.Constructor.prototypeF3.thumbnail_getSelectedItems = function() {
				var selected = [];
			...
			$.fn.repeater.Constructor.prototypeF3.thumbnail_setSelectedItems = function( items, force ) {
			...
			//EXTENSION DEFINITION
			$.fn.repeater.viewTypesF3.thumbnail = {
				selected: function() {
		...
		function fillTemplate( itemData, template ) {
			...
			while ( !invalid && template.searchF3( '{{' ) >= 0 ) {
				replace( template );
			}
	...
	( function( $ ) {
		...
		var Scheduler = function( element, options ) {
			...
			this.$element = $( element );
			this.options = $.extend( {}, $.fn.schedulerF3.defaults, options );
			...
			this.$repeatIntervalSelect.selectlistF3();

			//initialize sub-controls
			this.$element.find( '.selectlist' ).selectlistF3();
			this.$startDate.datepickerF3( this.options.startDateOptions );
			this.$startTime.comboboxF3();
			// init start time
			if ( this.$startTime.find( 'input' ).val() === '' ) {
				this.$startTime.comboboxF3( 'selectByIndex', 0 );
			}

			// every 0 days/hours doesn't make sense, change if not set
			if ( this.$repeatIntervalSpinbox.find( 'input' ).val() === '0' ) {
				this.$repeatIntervalSpinbox.spinboxF3( {
					'value': 1,
					'min': 1
				} );
			} else {
			...
			this.$endAfter.spinboxF3( {
				'value': 1,
				'min': 1
			} );
			this.$endDate.datepickerF3( this.options.endDateOptions );
			this.$element.find( '.radio-custom' ).radioF3();
		...
		Scheduler.prototype = {
			...
			destroy: function() {
				...
				// destroy components
				this.$element.find( '.combobox' ).comboboxF3( 'destroy' );
				this.$element.find( '.datepicker' ).datepickerF3( 'destroy' );
				this.$element.find( '.selectlist' ).selectlistF3( 'destroy' );
				this.$element.find( '.spinbox' ).spinboxF3( 'destroy' );
				this.$element.find( '[type=radio]' ).radioF3( 'destroy' );
				this.$element.remove();
			...
			endSelectChanged: function( e, data ) {
				...
				if ( !data ) {
					selectedItem = this.$endSelect.selectlistF3( 'selectedItem' );
			...
			getValue: function() {
				...
				var interval = this.$repeatIntervalSpinbox.spinboxF3( 'value' );
				var pattern = '';
				var repeat = this.$repeatIntervalSelect.selectlistF3( 'selectedItem' ).value;
				var startTime;

				if ( this.$startTime.comboboxF3( 'selectedItem' ).value ) {
					startTime = this.$startTime.comboboxF3( 'selectedItem' ).value;
					startTime = startTime.toLowerCase();

				} else {
					startTime = this.$startTime.comboboxF3( 'selectedItem' ).text.toLowerCase();
				}

				var timeZone = this.$timeZone.selectlistF3( 'selectedItem' );
				...
				startDateTime = '' + getFormattedDate( this.$startDate.datepickerF3( 'getDate' ), '-' );

				startDateTime += 'T';
				hasAm = ( startTime.searchF3( 'am' ) >= 0 );
				hasPm = ( startTime.searchF3( 'pm' ) >= 0 );
				...
				if ( repeat === 'none' ) {
					...
					if ( type === 'bymonthday' ) {
						day = parseInt( this.$element.find( '.repeat-monthly-date .selectlist' ).selectlistF3( 'selectedItem' ).text, 10 );
						pattern += 'BYMONTHDAY=' + day + ';';
					} else if ( type === 'bysetpos' ) {
						days = this.$element.find( '.month-days' ).selectlistF3( 'selectedItem' ).value;
						pos = this.$element.find( '.month-day-pos' ).selectlistF3( 'selectedItem' ).value;
						pattern += 'BYDAY=' + days + ';';
					...
					if ( type === 'bymonthday' ) {
						month = this.$element.find( '.repeat-yearly-date .year-month' ).selectlistF3( 'selectedItem' ).value;
						day = this.$element.find( '.year-month-day' ).selectlistF3( 'selectedItem' ).text;
						pattern += 'BYMONTH=' + month + ';';
						pattern += 'BYMONTHDAY=' + day + ';';
					} else if ( type === 'bysetpos' ) {
						days = this.$element.find( '.year-month-days' ).selectlistF3( 'selectedItem' ).value;
						pos = this.$element.find( '.year-month-day-pos' ).selectlistF3( 'selectedItem' ).value;
						month = this.$element.find( '.repeat-yearly-day .year-month' ).selectlistF3( 'selectedItem' ).value;
				...
				var end = this.$endSelect.selectlistF3( 'selectedItem' ).value;
				var duration = '';
				...
				if ( repeat !== 'none' ) {
					if ( end === 'after' ) {
						duration = 'COUNT=' + this.$endAfter.spinboxF3( 'value' ) + ';';
					} else if ( end === 'date' ) {
						duration = 'UNTIL=' + getFormattedDate( this.$endDate.datepickerF3( 'getDate' ), '' ) + ';';
					}
			...
			repeatIntervalSelectChanged: function( e, data ) {
				...
				if ( !data ) {
					selectedItem = this.$repeatIntervalSelect.selectlistF3( 'selectedItem' );
					val = selectedItem.value;
			...
			setValue: function( options ) {
				...
				if ( options.startDateTime ) {
					...
					if ( temp[ 1 ] ) {
						...
						this.$startTime.comboboxF3( 'selectByText', temp );
					} else {
						startTime = '00:00';
					}
				} else {
					startTime = '00:00';
					var currentDate = this.$startDate.datepickerF3( 'getDate' );
				...
				if ( options.timeZone ) {
					...
					this.$timeZone.selectlistF3( 'selectBySelector', item );
				} else if ( options.startDateTime ) {
					temp = options.startDateTime.split( 'T' )[ 1 ];
					if ( temp ) {
						if ( temp.searchF3( /\+/ ) > -1 ) {
							temp = '+' + $.trim( temp.split( '+' )[ 1 ] );
						} else if ( temp.searchF3( /\-/ ) > -1 ) {
							temp = '-' + $.trim( temp.split( '-' )[ 1 ] );
						} else {
							temp = '+00:00';
						}
				...
				if ( options.recurrencePattern ) {
					...
					if ( recur.FREQ === 'DAILY' ) {
						...
						if ( recur.BYMONTHDAY ) {
							...
							temp.find( '.selectlist' ).selectlistF3( 'selectByValue', recur.BYMONTHDAY );
						} else if ( recur.BYDAY ) {
							temp = this.$element.find( '.repeat-monthly-day' );
							temp.find( 'input' ).addClass( 'checked' ).prop( 'checked', true );
							temp.find( 'label.radio-custom' ).addClass( 'checked' );
							if ( recur.BYSETPOS ) {
								temp.find( '.month-day-pos' ).selectlistF3( 'selectByValue', recur.BYSETPOS );
							}

							temp.find( '.month-days' ).selectlistF3( 'selectByValue', recur.BYDAY );
						}
						...
						if ( recur.BYMONTHDAY ) {
							...
							temp.find( 'label.radio-custom' ).addClass( 'checked' );
							if ( recur.BYMONTH ) {
								temp.find( '.year-month' ).selectlistF3( 'selectByValue', recur.BYMONTH );
							}

							temp.find( '.year-month-day' ).selectlistF3( 'selectByValue', recur.BYMONTHDAY );
						} else if ( recur.BYSETPOS ) {
							temp = this.$element.find( '.repeat-yearly-day' );
							temp.find( 'input' ).addClass( 'checked' ).prop( 'checked', true );
							temp.find( 'label.radio-custom' ).addClass( 'checked' );
							temp.find( '.year-month-day-pos' ).selectlistF3( 'selectByValue', recur.BYSETPOS );
							if ( recur.BYDAY ) {
								temp.find( '.year-month-days' ).selectlistF3( 'selectByValue', recur.BYDAY );
							}
					...
					if ( recur.COUNT ) {
						this.$endAfter.spinboxF3( 'value', parseInt( recur.COUNT, 10 ) );
						this.$endSelect.selectlistF3( 'selectByValue', 'after' );
					} else if ( recur.UNTIL ) {
						temp = recur.UNTIL;
						if ( temp.length === 8 ) {
							temp = temp.split( '' );
						...
						this.$endDate.datepickerF3( 'setDate', utcEndHours );

						this.$endSelect.selectlistF3( 'selectByValue', 'date' );
					} else {
						this.$endSelect.selectlistF3( 'selectByValue', 'never' );
					}

					this.endSelectChanged();

					if ( recur.INTERVAL ) {
						this.$repeatIntervalSpinbox.spinboxF3( 'value', parseInt( recur.INTERVAL, 10 ) );
					}

					this.$repeatIntervalSelect.selectlistF3( 'selectByValue', item );
					this.repeatIntervalSelectChanged();
				}

				var utcStartHours = this.setUtcTime( startDate, startTime, timeOffset );

				this.$startDate.datepickerF3( 'setDate', utcStartHours );
			},

			toggleState: function( action ) {
				this.$element.find( '.combobox' ).comboboxF3( action );
				this.$element.find( '.datepicker' ).datepickerF3( action );
				this.$element.find( '.selectlist' ).selectlistF3( action );
				this.$element.find( '.spinbox' ).spinboxF3( action );
				this.$element.find( '[type=radio]' ).radioF3( action );
		...
		$.fn.schedulerF3 = function( option ) {
			var args = Array.prototype.slice.call( arguments, 1 );
			var methodReturn;
		...
		$.fn.schedulerF3.defaults = {};

		$.fn.schedulerF3.Constructor = Scheduler;

		$.fn.schedulerF3.noConflict = function() {
			$.fn.schedulerF3 = old;
			return this;
		};
		...
		$( document ).on( 'mousedown.fu.scheduler.data-api', '[data-initialize=scheduler]', function( e ) {
			...
			if ( !$control.data( 'fu.scheduler' ) ) {
				$control.schedulerF3( $control.data() );
			}
		} );
